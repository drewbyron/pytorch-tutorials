...
**TLDR:** By the end of the series a pytorch computer vision novice should have the tools to train any of the models we cover on a custom dataset (Part 1 - Part 4) and also quickly apply a trained mask rcnn model to real images and videos (Part 5). 
